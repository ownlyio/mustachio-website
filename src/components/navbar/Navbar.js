                        ...
                        <ul class="nav col-12 col-lg-auto me-lg-auto justify-content-center mb-0">
                            ...
                            <li>
                                <div style={{"marginLeft": "1rem"}}>
                                    <button id="app-mint-button" className="btn btn-custom-2 font-w-hermann w-hermann-semibold d-none d-md-block ml-2" type="button" onClick={props.mintBtn}>MINT YOUR MUSTACHIO!</button>
                                </div>
                            </li>
                        </ul>
                    </div>
                    
                    <div class="d-block d-md-none pe-1 cursor-pointer" id="show-mobile-nav">
                        <i class="fas fa-bars text-white font-size-150"></i>
                    </div>
                </div>
